  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="underline"> BE</span>
        {' '}
        technologies.
        ...
        .
        <Link className="inline-block bg-gray-100 rounded-full inset-0 px-3 dark:bg-gray-800" to={{ pathname: '/about' }}>
          {' '}
          More
          details
          {' '}
